...
V3_OUTPUT_DIR = REPO_ROOT / "configs" / "public_formal_disaster_v3"
PRIOR_OUTPUT_DIR = REPO_ROOT / "configs" / "public_formal_disaster_v3_1"
OUTPUT_DIR = REPO_ROOT / "configs" / "public_formal_disaster_v3_2"
SEEDS = (3101, 3102, 3103, 3104, 3105)
PROTOCOL_VERSION = "formal-public-disaster-protocol-v3.2.0"
MATRIX_SCHEMA_VERSION = "formal-public-disaster-matrix-v1.2.0"
...
def build_config(composition: str, mode: str, seed: int, slot: str) -> dict:
    ...
    run_id = f"public-disaster-v3p2-{composition}-{mode}-s{seed}-w{slot}"
    ...
    config["llm_defaults"]["max_tokens"] = 1024
