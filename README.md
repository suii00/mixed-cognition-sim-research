...
**[公開成果物をブラウザーで開く](https://suii00.github.io/mixed-cognition-sim-research/)** — 警報保持のA/B比較、避難所配置4 runのreplay、過去の日本語プロンプト実行のHTML・動画を一覧から閲覧できます。ダウンロードは必須ではありません。実験条件と生ログは以下の結果レポートに収録しています。[公開方法と再解析の注意](docs/PAGES_PUBLICATION.md)。
